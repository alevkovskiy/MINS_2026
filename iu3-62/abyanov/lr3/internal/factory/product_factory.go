...
type ProductFactory interface {
	CreateProduct(id, name string, quantity int, price float64, params map[string]interface{}) (domain.Product, error)
	GetCategory() string
}
...
func (f *FoodFactory) CreateProduct(id, name string, quantity int, price float64, params map[string]interface{}) (domain.Product, error) {
...
func (e *ElectronicsFactory) CreateProduct(id, name string, quantity int, price float64, params map[string]interface{}) (domain.Product, error) {
...
func (c *ChemicalsFactory) CreateProduct(id, name string, quantity int, price float64, params map[string]interface{}) (domain.Product, error) {
